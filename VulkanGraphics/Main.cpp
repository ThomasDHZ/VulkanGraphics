...
private:
	...
	{
		uint32_t imageIndex;
		VkSemaphore image_acquired_semaphore = imageAvailableSemaphores[currentFrame];
		VkSemaphore render_complete_semaphore = renderFinishedSemaphores[currentFrame];
		VkResult result = vkAcquireNextImageKHR(device, swapChain, UINT64_MAX, image_acquired_semaphore, VK_NULL_HANDLE, &imageIndex);
