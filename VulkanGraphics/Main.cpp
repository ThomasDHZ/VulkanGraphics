...
private:
	...
	void createDescriptorSets() {
		std::vector<VkDescriptorSetLayout> layouts(renderer.GetSwapChainImageCount(), renderer.GraphicsPipeline.ShaderPipelineDescriptorLayout);
	...
	void createCommandBuffers() {
		...
		for (size_t i = 0; i < commandBuffers.size(); i++) 
		{
			...
			vkCmdBindPipeline(commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, renderer.GraphicsPipeline.ShaderPipeline);
			vkCmdBindVertexBuffers(commandBuffers[i], 0, 1, vertexBuffers, offsets);
			vkCmdBindIndexBuffer(commandBuffers[i], indexBuffer, 0, VK_INDEX_TYPE_UINT16);
			vkCmdBindDescriptorSets(commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, renderer.GraphicsPipeline.ShaderPipelineLayout, 0, 1, &descriptorSets[i], 0, nullptr);
