...
bool BaseRenderer::isDeviceSuitable(VkPhysicalDevice device)
{
...
bool BaseRenderer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
VkSurfaceFormatKHR BaseRenderer::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats) {
...
VkPresentModeKHR BaseRenderer::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes) {
...
VkExtent2D BaseRenderer::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities) {
...
void BaseRenderer::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
VkImageView BaseRenderer::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
void BaseRenderer::createSurface(VkInstance instance)
{
...
void BaseRenderer::pickPhysicalDevice(VkInstance instance)
{
...
void BaseRenderer::createRenderPass(VkSubpassDescription subpass, VkSubpassDependency dependency, std::vector<VkAttachmentDescription> attachments)
{
...
void BaseRenderer::createDescriptorSetLayout(std::vector<VkDescriptorSetLayoutBinding> bindings)
{
...
void BaseRenderer::createFramebuffers(std::vector<VkImageView> attachments, int Image)
{
	...
	if (vkCreateFramebuffer(device, &framebufferInfo, nullptr, &swapChainFramebuffers[Image]) != VK_SUCCESS) {
...
VulkanDevice BaseRenderer::UpdateDeviceInfo()
{
	...
	vulkanDevice.SwapChainSize = swapChainImageViews.size();
