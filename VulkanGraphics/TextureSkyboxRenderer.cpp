...
TextureSkyboxRenderer::TextureSkyboxRenderer(VkDevice Device, VkPhysicalDevice PhysicalDevice, VkExtent2D extent, std::vector<VkImageView> swapChainImageViews)
{
...
void TextureSkyboxRenderer::CreateRenderPass(VkDevice Device)
{
...
void TextureSkyboxRenderer::CreateDescriptorSets(VkDevice Device)
{
...
void TextureSkyboxRenderer::CreateRenderingPipeline(VkDevice Device, VkExtent2D swapChainExtent)
{
...
void TextureSkyboxRenderer::CreateRendererFramebuffers(VkDevice Device, VkExtent2D swapChainExtent, std::vector<VkImageView> swapChainImageViews)
{
