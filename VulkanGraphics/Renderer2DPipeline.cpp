...
Renderer2DPipeline::Renderer2DPipeline() : GraphicsPipeline()
{
}

Renderer2DPipeline::Renderer2DPipeline(VkExtent2D swapChainExtent, VkRenderPass& renderPass, VkDevice device) : GraphicsPipeline(device, PipeLineType::Pipeline_FowardRenderer)
{
...
void Renderer2DPipeline::CreateDescriptorSetLayout()
{
...
void Renderer2DPipeline::CreateShaderPipeLine(VkExtent2D swapChainExtent, VkRenderPass& renderPass, VkDevice device)
{
	auto vertShaderCode = ReadShaderFile("shaders/Renderer2DVert.spv");
	auto fragShaderCode = ReadShaderFile("shaders/Renderer2DFrag.spv");
