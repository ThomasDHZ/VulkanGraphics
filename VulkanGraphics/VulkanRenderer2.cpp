...
VulkanRenderer2::VulkanRenderer2(GLFWwindow* window)
{
...
VkFormat VulkanRenderer2::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
...
VkFormat VulkanRenderer2::findDepthFormat()
{
...
std::vector<const char*> VulkanRenderer2::getRequiredExtensions() {
...
bool VulkanRenderer2::isDeviceSuitable(VkPhysicalDevice GPUDevice)
{
...
bool VulkanRenderer2::checkDeviceExtensionSupport(VkPhysicalDevice GPUDevice)
{
...
void VulkanRenderer2::FindQueueFamilies(VkPhysicalDevice PhysicalDevice, VkSurfaceKHR Surface)
{
...
void VulkanRenderer2::InitializeVulkan(GLFWwindow* window)
{
...
void VulkanRenderer2::InitializeRenderPass()
{
...
void VulkanRenderer2::InitializeFramebuffers()
{
