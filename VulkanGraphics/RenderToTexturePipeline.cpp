...
RenderToTexturePipeline::RenderToTexturePipeline() : GraphicsPipeline()
{
}

RenderToTexturePipeline::RenderToTexturePipeline(VkExtent2D swapChainExtent, VkRenderPass& renderPass, VkDevice device) : GraphicsPipeline(device, PipeLineType::Pipeline_FowardRenderer)
{
...
void RenderToTexturePipeline::CreateDescriptorSetLayout()
{
...
void RenderToTexturePipeline::CreateShaderPipeLine(VkExtent2D swapChainExtent, VkRenderPass& renderPass, VkDevice device)
{
...
void RenderToTexturePipeline::UpdateGraphicsPipeLine(VkExtent2D swapChainExtent, VkRenderPass& renderPass, VkDevice device)
{
	CreateShaderPipeLine(swapChainExtent, renderPass, device);
}