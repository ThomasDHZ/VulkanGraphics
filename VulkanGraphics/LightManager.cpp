...
void LightManager::UpdateLights()
{
	...
	if (selectedNode == 0)
	{
		ImGui::NextColumn();
		ImGui::LabelText("", "Directional");
		ImGui::SliderFloat3("PointLight0Pos", PointLightList[0].GetLightPosPtr(), -10.0f, 10.0f);
		ImGui::ColorEdit3("PointLight0Ambient", PointLightList[0].GetAmbientPtr());
		ImGui::ColorEdit3("PointLight0Diffuse", PointLightList[0].GetDiffusePtr());
		ImGui::ColorEdit3("PointLight0Specular", PointLightList[0].GetSpecularPtr());
		ImGui::NextColumn();
	}
	else if (selectedNode == 1)
	{
		...
		ImGui::SliderFloat3("PointLight1Pos", PointLightList[1].GetLightPosPtr(), -10.0f, 10.0f);
		ImGui::ColorEdit3("PointLight1Ambient", PointLightList[1].GetAmbientPtr());
		ImGui::ColorEdit3("PointLight1Diffuse", PointLightList[1].GetDiffusePtr());
		ImGui::ColorEdit3("PointLight1Specular", PointLightList[1].GetSpecularPtr());
		ImGui::NextColumn();
	}
