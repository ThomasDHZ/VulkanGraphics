...
LevelMesh2D::LevelMesh2D(VulkanRenderer& renderer, const TileSet& tileSet)
{
...
void LevelMesh2D::LoadTiles(VulkanRenderer& renderer, const TileSet& tileSet)
{
...
void LevelMesh2D::Update(VulkanRenderer& renderer, Camera& camera)
{
	//LevelMesh.Update(renderer, camera, light);
}

void LevelMesh2D::Draw(VulkanRenderer& renderer, int currentFrame)
{
