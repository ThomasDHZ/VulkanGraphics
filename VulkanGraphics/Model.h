...
public:
	...
	void UpdateUniformBuffer(VulkanRenderer& Renderer, PositionMatrix ubo2, AmbientLightUniformBuffer light, Lighter lighter, Material material, ViewPos viewpos, int currentImage);
