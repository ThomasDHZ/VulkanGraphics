...
BloomRenderer2::BloomRenderer2() : RendererBase()
{
}

BloomRenderer2::BloomRenderer2(VulkanRenderer& renderer) : RendererBase(renderer)
{
    ...
    ImGui_ImplVulkan_AddTexture(BloomTexture->ImGuiDescriptorSet, BloomTexture->GetTextureSampler(), BloomTexture->GetTextureView(), VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
}

BloomRenderer2::~BloomRenderer2()
{
}

void BloomRenderer2::CreateRenderPass(VulkanRenderer& renderer)
{
...
void BloomRenderer2::CreateRendererFramebuffers(VulkanRenderer& renderer)
{
    SwapChainFramebuffers.resize(3);
    for (size_t i = 0; i < renderer.SwapChain.GetSwapChainImageCount(); i++)
    {
        VkImageView attachments[2];
        attachments[0] = BloomTexture->View;
...
void BloomRenderer2::UpdateSwapChain(VulkanRenderer& renderer)
{
...
void BloomRenderer2::Destroy(VulkanRenderer& renderer)
{
