...
VkFormat ForwardRenderer::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features) {
	for (VkFormat format : candidates) {
		...
		vkGetPhysicalDeviceFormatProperties(swapChain.DeviceInfo.PhysicalDevice, format, &props);
...
void ForwardRenderer::SetUpRenderPass()
{
	...
	if (vkCreateRenderPass(swapChain.DeviceInfo.Device, &renderPassInfo, nullptr, &renderPass) != VK_SUCCESS) {
