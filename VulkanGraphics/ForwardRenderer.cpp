...
ForwardRenderer::ForwardRenderer(VkInstance instance, GLFWwindow* window)
{
	Window = window;
...
bool ForwardRenderer::isDeviceSuitable(VkPhysicalDevice device)
{
...
QueueFamilyIndices ForwardRenderer::findQueueFamilies(VkPhysicalDevice device) {
...
bool ForwardRenderer::checkDeviceExtensionSupport(VkPhysicalDevice device) {
...
SwapChainSupportDetails ForwardRenderer::querySwapChainSupport(VkPhysicalDevice device) {
...
void ForwardRenderer::createImage(uint32_t width, uint32_t height, VkFormat format, VkImageTiling tiling, VkImageUsageFlags usage, VkMemoryPropertyFlags properties, VkImage& image, VkDeviceMemory& imageMemory) {
...
uint32_t  ForwardRenderer::findMemoryType(uint32_t typeFilter, VkMemoryPropertyFlags properties) {
...
VkImageView ForwardRenderer::createImageView(VkImage image, VkFormat format, VkImageAspectFlags aspectFlags) {
...
VkShaderModule ForwardRenderer::createShaderModule(const std::vector<char>& code) {
...
void ForwardRenderer::createSurface(VkInstance instance) 
{
...
void ForwardRenderer::pickPhysicalDevice(VkInstance instance) 
{
...
void ForwardRenderer::createLogicalDevice() {
...
void ForwardRenderer::DeleteSwapChain()
{
...
VulkanDevice ForwardRenderer::UpdateDeviceInfo()
{
