...
void VulkanGraphics::UpdateImGUI()
{
	...
	ImGui::NewFrame();
	{
		...
		ImGui::SliderFloat3("pLight", &light.light.pLight[1].position.x, -10.0f, 10.0f);
		ImGui::SliderFloat3("pambient", &light.light.pLight[1].ambient.x, 0.0f, 1.0f);
		ImGui::SliderFloat3("pdiffuse", &light.light.pLight[1].diffuse.x, 0.0f, 1.0f);
		ImGui::SliderFloat3("pspecular", &light.light.pLight[1].specular.x, 0.0f, 1.0f);
		for (auto& sprite : SpriteList)
		{
